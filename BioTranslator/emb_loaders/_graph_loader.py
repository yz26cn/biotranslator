"""
pathway graph structure encoder
"""
import os
import numpy as np
import pandas as pd
...
from .BioUtils import load, load_obj, proteinData, emb2tensor, gen_go_emb, organize_workingspace, \
    term_training_numbers, extract_terms_from_dataset
