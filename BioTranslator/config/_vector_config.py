class VectorConfig:
    ...
    def load_args(self, args):
        ...
        self.dataset = args['vec_dataset'].strip()
        self.eval_dataset = args['vec_eval_dataset'].strip()
        self.method = args['method'].strip()
        self.task = args['vec_task'].strip()
        self.data_repo = args['data_repo'].strip()
        self.ontology_repo = args['vec_ontology_repo'].strip()
